 ...
 */
void evaluate_children_cuda(CacheTree* tree, Node* parent, tracking_vector<unsigned short, DataStruct::Tree> parent_prefix,
 ...
 */
int bbound_cuda(CacheTree* tree, size_t max_num_nodes, Queue* q, PermutationMap* p) {
    size_t num_iter = 0;
    int cnt;
