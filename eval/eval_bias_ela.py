...
pylab.legend(('TPR (open)', 'FPR (solid)'), fontsize=fs, numpoints=1, loc='lower left', frameon=False, borderpad=0.2)
pylab.subplot(1, 2, 2)
pylab.plot(-1, -1, 'D', markerfacecolor='w', markeredgecolor='k', markersize=6, markeredgewidth=2)
pylab.plot(-1, -1, 'D', markerfacecolor='k', markersize=8, markeredgewidth=1, markeredgecolor='gray')
pylab.legend(('TNR (open)', 'FNR (solid)'), fontsize=fs, numpoints=1, loc='lower left', frameon=False, borderpad=0.2)
...
for fold in range(num_folds):
    ...
    pylab.plot(3 + offset, white_tpr, 's', markerfacecolor='w', markeredgecolor='b', markersize=6, markeredgewidth=2)
    pylab.plot(3 + offset, white_fpr, 's', markerfacecolor='b', markersize=7, markeredgewidth=1, markeredgecolor='gray')
    ...
    pylab.subplot(1, 2, 2)
    pylab.plot(1 + offset, black_tnr, 'd', markerfacecolor='w', markeredgecolor='darkred', markersize=6, markeredgewidth=2)
    pylab.plot(1 + offset, black_fnr, 'd', markerfacecolor='darkred', markersize=8, markeredgewidth=1, markeredgecolor='gray')
    pylab.plot(3 + offset, white_tnr, 's', markerfacecolor='w', markeredgecolor='c', markersize=6, markeredgewidth=2)
    pylab.plot(3 + offset, white_fnr, 's', markerfacecolor='c', markersize=7, markeredgewidth=1, markeredgecolor='gray')
    pylab.axis([0.5, 4.5, 0, 0.89])
    pylab.xticks(np.array([1, 2, 3, 4]) + 0.1,  ['Black\n(CORELS)', 'Black\n(COMPAS)', 'White\n(CORELS)', 'White\n(COMPAS)'], fontsize=fs-2)
    pylab.yticks(np.arange(0, 0.9, 0.2), fontsize=fs)
    ...
    pylab.subplot(1, 2, 2)
    pylab.plot(2 + offset, black_tnr, 'd', markerfacecolor='w', markeredgecolor='darkred', markersize=6, markeredgewidth=2)
    pylab.plot(2 + offset, black_fnr, 'd', markerfacecolor='darkred', markersize=8, markeredgewidth=1, markeredgecolor='gray')
