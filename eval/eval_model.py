...
def run_model(fname, log_fname):
    #./bbcache [-s] [-b] [-n max_num_nodes] [-r regularization] [-v verbosity] -c (1|2) -p (0|1|2) [-f logging_frequency]data.out data.label
    #fname = '../logs/for-tdata_R.out-curiosity-with_prefix_perm_map-max_num_nodes=100000-c=0.0010000-v=1-f=1000-opt.txt'
