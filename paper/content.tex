...
optimal rule lists in~$\StartsWith(\PrefixB)$
...
Theorem~\ref{thm:similar} implies that if prefix~$\Prefix$
...
\item Figure~\ref{fig:queue-cache-size},
...
\includegraphics[width=0.65\textwidth]{figs/ela-queue-cache-size-insertions.png}
\end{center}
...
\includegraphics[width=0.65\textwidth]{figs/ela-objective.png}
\end{center}
...
\includegraphics[width=0.65\textwidth]{figs/ela-remaining-space.png}
\end{center}
