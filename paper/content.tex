...
all rule lists formed from a set~${\RuleSet = \{s_m \}_{m=1}^M}$ of~$M$ rules.
%
...
on the current best objective, ${\CurrentObj \le 0.5}$,
and the queue will contain~$M$ elements.
%
By~\eqref{eq:max-length}, ${K = \lfloor 0.5 / c \rfloor}$ gives
