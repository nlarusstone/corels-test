...
\begin{proof}
First note that since rule lists consist of distinct rules,
$M$~gives the maximum rule list length.
%
...
\begin{proof}
First note that $M$~gives the maximum rule list length;
also, note that~${K' \ge K}$, since~$\Prefix'$ starts with~$\Prefix$.
%
