...
a subset of~$K$ antecedents in~$\Prefix'$ correspond to
the set of all antecedents in~$\Prefix$, in any order,
for all ${K' \ge K}$.
%
...
\begin{corollary}[Propagation of insufficient rule support]
