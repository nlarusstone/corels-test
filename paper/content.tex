...
Our next upper bound on the number of prefix evaluations is
strictly tighter than the bound in Corollary 2, because it
uses the current best objective to constrain the lengths of
all prefixes in the remaining search space.
