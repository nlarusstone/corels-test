...
\begin{theorem}
Define bound~${b(\Prefix, \x, \y) = \Loss_p(\Prefix, \Labels, \x, \y) + \Reg K}$.
%
...
%
Thus, even if we find that~${b(\Prefix) < \CurrentObj}$, we can still prune all longer
prefixes~$\Prefix'$ if ${b(\Prefix') \ge \CurrentObj}$,
