...
In the next two subsections, we prove
...
followed by some things about symmetry~(\S\ref{sec:})
and another corresponding upper bound on the number of prefix evaluations~(\S\ref{sec:permutation-counting}), \dots
...
\subsection{Permutation bound for symmetry-aware garbage collection}
