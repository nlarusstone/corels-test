...
\begin{table}[h]
\centering
\caption{\small Tabulation of average runtime and memory usage (in blue) over 3 runs on different datasets with and without symmetry-aware map, tested on a 2.6 GHz i7-6700HQ and 16 GB RAM, capped at 12 GB. Standard deviations are within 1\% of reported values in all cases.}
