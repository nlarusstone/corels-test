...
M.I.J. for pointing out the work by~\citet{Bertsimas16},
which influenced the section on algorithmic speedup~(\S\ref{sec:speedup}), V.~Kanade, S.~McCurdy,
...
and mining rules, B.~Coker for his critical advice on using the ProPublica COMPAS dataset,
