...
%
We compare CORELS against other tree (C4.5, CART)
and rule list (RIPPER, SBRL) learning algorithms.
%
For CORELS, C4.5, and CART, we vary parameters~$\Reg$, $C$, and~$cp$, respectively.
}
\label{fig:sparsity}
\end{figure}
...
CORELS without the equivalent points bound remains from complete,
