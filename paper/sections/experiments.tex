...
% left lower right upper
\includegraphics[trim={30mm 15mm 35mm 25mm}, width=0.45\textwidth]{figs/ela_compas_compare_small-queue.pdf}
\end{kdd}
\end{center}
\caption{Queue composition. % logical queue
%
Numbers of prefixes in the queue, colored by length (log scale),
...
through~5 in the top left figure; it approximates
