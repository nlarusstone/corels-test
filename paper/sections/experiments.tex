...
The objective drops quickly, within the first millisecond and then slowly
converges to the optimal.
In contrast, the search space steadily shrinks throughout the run as the
lower bound slowly converges to the optimal objective.
...
Figure \ref{fig:ablation} presents a view of the same experiments, focusing
