...
%
Bottom:  We use the New York Civil Liberties Union's 2014 stop-and-frisk
...
%
Figures~\ref{fig:sparsity} and~\ref{fig:frisk-sparsity} show that CORELS
can learn short rule lists without sacrificing accuracy.
