...
\end{center}
\caption{CORELS and selected variants,
for ProPublica (${\Reg = 0.005}$, ${M = 155}$) (left)
and NYCLU (${\Reg = 0.01}$, ${M = 46}$) (right).
%
...
%
For CORELS (solid lines) with the ProPublica dataset (left),
