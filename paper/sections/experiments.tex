...
\begin{kdd}
% left lower right upper
\includegraphics[trim={20mm, 10mm, 20mm, 15mm}, width=0.45\textwidth]{figs/frisk-sparsity.pdf}
\end{kdd}
\end{center}
\caption{Test accuracy as a function of model size,
...
%
We do depict neither RIPPER, which we were unable to execute,
nor C4.5, which finds models with $>1000$ leaves
