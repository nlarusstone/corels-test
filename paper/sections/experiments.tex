...
\end{kdd}
\end{center}
\caption{CORELS with (solid lines) and without
...
Note that the last row did not terminate.
%
...
the remaining search space decrease as CORELS executes on the ProPublica
dataset.
...
\includegraphics[width=\textwidth]{figs/ela_compas_ablation-queue.pdf}
\end{arxiv}
\begin{kdd}
