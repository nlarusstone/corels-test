...
CORELS does not automatically choose the subgroup with the highest likelihood of a
...
%
It also is not designed to assist with causal inference applications, since
...
%
CORELS is not easy to adapt in its current form to similar problems,
