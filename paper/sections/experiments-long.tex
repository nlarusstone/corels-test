...
No priority queue (BFS) & 6.7 (2.2) & 1.2$\times$ & 4 (1) & 5-6 \\
No support bounds & 10.2 (3.4) & 1.8$\times$ & 13 (4) & 5-6 \\
No symmetry-aware map & 58.6 (23.3) & 9.0$\times$ & 23 (6) & 5-6 \\
No lookahead bound & 71.9 (23.0) & 12$\times$ & 9 (2) & 6-7 \\
%equiv. pts. bound & 188.6 (104.6) & 6178 (1840) & 803.8 (0.1) & 790.5 (0.4) & 10-10
No equivalent pts bound & $>$134 & $>64\times$ & $>$7168* & $\ge$10 \\
\hline
\end{tabular}
...
%
The columns report total execution time~(min),
time to optimum~(s),  maximum evaluated prefix length,
total number of evaluated prefixes~(millions),
total number of queue insertions~(millions),
...
%
We also report the slowdown in mean total execution time,
