...
However, if we look at how processor speeds have changed over the last 25 years, we can see that the fastest supercomputer in the world
in 1993 ran at 131.0 GFlops/s~\citep{Supercomputer}.

computers are about 1,000,000 faster now than they were in 1993
...
width=0.8\textwidth]{figs/compas-sparsity-training.pdf}
\includegraphics[trim={12mm, 5mm, 24mm, 1mm},
width=0.8\textwidth]{figs/frisk-sparsity-training.pdf}
\end{center}
...
width=0.7\textwidth]{figs/compas_execution_large-remaining-space.pdf}
\end{center}
