...
as well as the datasets and prediction problems we use,
...
and Table~2 summarizes feature sets extracted from each dataset,
...
at predicting two-year recidivism for the ProPublica dataset (Figure~\ref{fig:compas-comparison}).
%
...
However, CORELS examines only 28 million prefixes in total---a reduction factor of~893 compared to examining
