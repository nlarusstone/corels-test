...
width=0.78\textwidth]{figs/compare-compas-weapon.pdf}
\end{center}
...
%
In particular, the authors argue for a simple and interpretable stop rule that
could potentially be used by police officers, and present an effective
heuristic that combines three stop criteria, based on a reduced version of their
