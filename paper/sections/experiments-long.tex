...
\begin{center}
% left lower right upper
\includegraphics[trim={0mm 0mm 0mm 5mm}, width=\textwidth]{figs/jmlr_compas_ablation-queue.pdf}
\end{center}
\vspace{-5mm}
...
\includegraphics[trim={0mm 0mm 0mm 5mm}, width=\textwidth]{figs/weapon_ablation-queue.pdf}
\end{center}
\vspace{-5mm}
\caption{Summary of the logical queue's contents, for full CORELS (top left)
and five variants that each remove a specific implementation optimization or bound,
