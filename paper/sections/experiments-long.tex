...
using a feature set that includes age categories ($<$25, 25-45, $>$45) from the ProPublica dataset,
as well as race categories (African American, Asian, Caucasian, Hispanic,
...
%
To explore the effect of a different discretization of the age attribute,
