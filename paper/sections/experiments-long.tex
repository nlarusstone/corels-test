...
%
For experiments in Sections~\ref{sec:examples} and~\ref{sec:frisk}, and Appendix~\ref{appendix:nypd},
...
%
We also consider a second, similar antecedent set in Sections~\ref{sec:examples} and~\ref{sec:frisk},
derived from a subset of Feature Set~C that excludes~8 location-specific binary features (Feature Set~D).

Throughout our experiments, we also use a smaller stop-and-frisk dataset,
...
single-clause antecedents (including negations).
...
%
In Appendix~\ref{appendix:cpw}, we show Figure~\ref{fig:sparsity-cpw}, which is similar to
Figure~\ref{fig:sparsity-weapon} but uses the larger NYPD dataset.
