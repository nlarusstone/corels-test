...
%\includegraphics[width=0.75\textwidth]{figs/sketch-comparison.png}
% left lower right upper
\includegraphics[trim={17mm, 10mm, 27mm, 0mm},
width=0.82\textwidth]{figs/weapon-sparsity-jmlr.pdf}
%\vspace{-4mm}

\end{center}
\caption{True positive rate (TPR, open markers) and false positive rate (FPR, solid markers)
...
for CORELS summarized in these two figures, see Appendix~\ref{appendix:examples}.
...
width=0.87\textwidth]{figs/weapon_reg-queue.pdf}
\end{center}
\vspace{-5mm}
