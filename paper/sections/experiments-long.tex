...
%
More generally, CORELS's all recover at least ${\ge 40\%}$ of weapons
on average, \ie more weapons than any of the heuristic models with~${T \ge 2}$,
which recover less than 25\% of weapons on average.
%
At the same time, CORELS's models all require fewer than

The bottom subfigure plots both TPR and FPR for each of the models in the top subfigure.
[??FIXME??]
