...
\begin{itemize}
\item How does CORELS' accuracy compare to other algorithms?
\item How does CORELS' model size compare to other algorithms?
\item How rapidly does the objective function converge?
\item How rapidly does CORELS prune the search space?
\item How much does each of the implementation optimizations contribute to CORELS' performance?
\end{itemize}
...
Our evaluation focuses on two socially-important prediction problems from recent,
publicly-available datasets:
\begin{itemize}
\item Predicting which individuals in the ProPublica COMPAS
dataset~\cite{LarsonMaKiAn16} recidivate within two years.
\item Using the NYCLU 2014 stop-and-frisk dataset~\cite{nyclu:2014} to predict
