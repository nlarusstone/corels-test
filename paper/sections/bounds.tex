...
\end{align}
Analogously, for any rule list~$\RL'$ whose prefix~$\Prefix'$ starts with~$\Prefix$,
$\Obj(\RL, \x, \y) \ge b(\Prefix, \x, \y) + b_0(\Prefix, \x, \y)$.
\begin{align}
...
b_0(\Prefix, \x, \y) &= \frac{1}{N} \sum_{u=1}^U \sum_{n=1}^N
    \neg\, \Cap(x_n, \Prefix) \wedge \one [ x_n \in e_u ] \wedge \one [ y_n = q_u ] \nn \\
&= \frac{1}{N} \sum_{u=1}^U \sum_{n=1}^N
    \left(\neg\, \Cap(x_n, \Prefix')+ \sum_{k=K+1}^{K'} \Cap(x_n, p_k \given \Prefix') \right) \wedge \one [ x_n \in e_u ] \wedge \one [ y_n = q_u ] \nn \\
&= b_0(\Prefix', \x, \y) + \frac{1}{N} \sum_{u=1}^U \sum_{n=1}^N
