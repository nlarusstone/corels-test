...
The bounds in this section quantify the following observation:
if multiple observations that are not captured by a prefix~$\Prefix$
have identical features and opposite labels, no rule list that
...
Thus, if there exist multiple observations that have identical features and
opposite labels, no rule list can correctly classify all observations.
%
