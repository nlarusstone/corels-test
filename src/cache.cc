...
Node<T>::Node(size_t nrules, bool default_prediction, double objective, double minority)
    : id_(0), default_prediction_(default_prediction),
      lower_bound_(minority), objective_(objective), done_(0), deleted_(0), depth_(0),
      storage_(0), num_captured_(0), minority_(minority) {
}
...
Node<T>::Node(unsigned short id, size_t nrules, bool prediction,
    ...
    : id_(id), prediction_(prediction), default_prediction_(default_prediction),
      ...
      storage_(storage), num_captured_(num_captured), minority_(minority) {
}
