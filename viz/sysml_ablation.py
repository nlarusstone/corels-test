"""
For SYSML Figure 1.  See also `kdd_compas_ablation.py` and `jmlr_compas_ablation.py`
...
log_dir = '/Users/nlarusstone/Documents/corels/bbcache/jmlr'
...
labels = ['CORELS', 'No symmetry-aware map']
ftag = "sysml_ablation"
        ...
        if (make_figure):
            ...
            if (ncomp + 1 == ntot):
                if make_small:
                    ...
                    pylab.suptitle('\nExecution traces of queue contents ({0} dataset)'.format(dst), fontsize=fs+2)
